...
describe('Transition', () => {
  it('Renders a wrapper around the animated component', () => {
    const classTree = renderer.create(<Transition><View style={styles.container} /></Transition>);
    // writeTree(classTree.toJSON());
  });

  it('Renders a wrapper around the animated component2', () => {
    const classTree = renderer.create(<Transition><View style={styles.container2} /></Transition>);
  });
