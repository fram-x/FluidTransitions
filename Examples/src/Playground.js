...
export default class Playground extends Component {
  ...
  animate = () => {
    Animated.timing(this._nativeProgress, { toValue: 1, useNativeDriver: true })
      .start(() =>
        Animated.timing(this._nativeProgress, { toValue: 0, useNativeDriver: true })
          .start());
  }
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        {cw(<View style={styles.buttons}><Button title="Button1" onPress={this.animate} /><Button title="Button2" onPress={this.animate} /></View>)}
